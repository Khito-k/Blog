...
import com.bzk.blog.enums.UploadModeEnum;
import com.bzk.blog.strategy.UploadStrategy;
...
public class UploadStrategyContext {
	...
	public String executeUploadStrategy(MultipartFile file, String path) {
		return uploadStrategyMap.
				get(UploadModeEnum.
						getStrategy(uploadMode)).uploadFile(file, path);
	}
